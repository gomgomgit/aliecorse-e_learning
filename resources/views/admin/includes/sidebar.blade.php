<aside class="sidenav navbar-vertical navbar-expand-xs fixed-start h-screen border-end border-2" id="sidenav-main" style="margin-top: 130px">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto pb-5" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark  {{ (request()->is('admin/course*')) ? 'active bg-gradient-info' : '' }}" href="{{ route('courses.index') }}">
                    <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="material-icons opacity-10 text-info">school</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-dark {{ (request()->is('admin/articles*')) ? 'active bg-gradient-info' : '' }}" href="{{ route("articles.index") }}">
                    <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="material-icons opacity-10 text-info">article</i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-dark {{ (request()->is('admin/categories*')) ? 'active bg-gradient-info' : '' }}" href="{{ route('categories.index') }}">
                    <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
