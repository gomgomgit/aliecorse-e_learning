<form action="{{ route('lessons.file-update', $lesson->id) }}" method="POST">
    @csrf
    @method('POST')
    <h6>Nama</h6>
    ...
    <div class="input-group input-group-dynamic">
        <textarea name="description" class="form-control" rows="5" placeholder="Masukkan Deskripsi" spellcheck="false">{{ $lesson->description }}</textarea>
    </div>
